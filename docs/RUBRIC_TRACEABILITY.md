...
`pytest` — **68 passing** across `test_dq_engine`, `test_pipeline` (incl. the end-to-end
...
fallbacks the 68-test suite exercises — the suite runs with no GPU, no network and no keys.
